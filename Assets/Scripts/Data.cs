...
public class Data : MonoBehaviour
{
    ...
    public float[] charTraningTime = { 1f, 1f, 2.5f, 2f, 1.25f, 2.5f, 2.5f, 2.5f, 5f, 2.5f, 2.5f, 7.2f, 2.5f, 2.5f, 7.5f, 2.5f };
    ...
    public float[] towerAttackRange = { 15f, 5f, 6f, 10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f };
    public float[] base_hp = { 500, 1100, 2000, 3200, 4700 };

    public string[] turret_name = { "Rock slingshot", "egg automatic", "primitive catapult", "Catapult", "Fire Catapult", "egg automatic", "Small Cannon", "Medium Cannon", "Big cannon", "gun", "rocket launcher", "double gun", "laser", "red pew pew", "blue pew pew" };
    public int[] turret_cost = { 100, 200, 500, 500, 750, 200, 1500, 3000, 6000, 7000, 9000, 14000, 24000, 40000, 100000 };
